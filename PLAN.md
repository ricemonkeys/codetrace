...
- `analysis_cache.json` — **gitignore 권장** (파생)
- `removed.log` — commit 또는 gitignore 모두 가능. 팀 정책에 위임.
...
- [ ] **폐기·정리** — 기존 `codetrace.addSelectionToCanvas` 명령 제거, 수동 코드 카드 코드 경로 제거, 폐기되는 React Flow 모듈 정리
